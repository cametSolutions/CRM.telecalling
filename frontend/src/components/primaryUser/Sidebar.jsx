...
//           bg-gradient-to-b from-[#eef3f9] to-[#e8eef6]
...
//       >
//         {/* Mobile header */}
//         <div className="flex items-center justify-between border-b border-slate-200 px-3 py-2.5 lg:hidden">
...
//             className="flex h-7 w-7 items-center justify-center rounded-full bg-white text-slate-600 shadow-sm transition hover:bg-slate-50"
//           >
//             {sidebarOpen ? (
//               <ChevronLeft size={14} />
//             ) : (
...
//             <div className="flex items-center gap-3 rounded-xl bg-white/60 px-2.5 py-2 shadow-sm ring-1 ring-white/70">
//               <button
//                 type="button"
//                 onClick={() => setAvatarOpen(true)}
//                 className="relative h-12 w-12 shrink-0 overflow-hidden rounded-full border border-white shadow-sm focus:outline-none focus:ring-2 focus:ring-sky-500"
//               >
//                 <img
//                   src={
//                     user?.profileUrl ||
...
//             <h4 className="text-[11px] font-semibold uppercase tracking-[0.08em] text-slate-600">
//               Score Board
//             </h4>
//           </div>
...
//           <div className="flex items-center justify-between border-b border-slate-200 bg-white/40 px-3 py-2">
...
//         >
//           <div className="px-3 pb-3 pt-2">
//             <div className="flex items-center gap-3 rounded-xl bg-white/10 px-2.5 py-2 shadow-sm ring-1 ring-white/10">
//               <button
//                 type="button"
//                 onClick={() => setAvatarOpen(true)}
//                 className="relative h-12 w-12 shrink-0 overflow-hidden rounded-full border border-white/20 shadow-sm focus:outline-none focus:ring-2 focus:ring-sky-400"
//               >
//                 <img
//                   src={
//                     user?.profileUrl ||
...
//               <div className="min-w-0 flex-1">
//                 <h3 className="truncate text-[13px] font-semibold leading-4 text-white">
//                   {user?.name || "John Smith"}
//                 </h3>
...
//           <div className="border-y border-cyan-900/40 bg-cyan-950/70 px-3 py-2">
//             <h4 className="text-[11px] font-semibold uppercase tracking-[0.08em] text-cyan-100">
//               Score Board
//             </h4>
//           </div>
...
//             <span className="text-[11px] font-semibold uppercase tracking-[0.08em] text-cyan-100">
//               Categories
//             </span>
