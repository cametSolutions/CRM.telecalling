          ...
          {/* <table className="min-w-[780px] w-full border-collapse text-sm">
            <thead className="sticky top-0 z-10 bg-gradient-to-r from-blue-600 to-indigo-600 text-white shadow-sm">
              <tr>
                ...
                <th className="min-w-[220px] px-4 py-3 text-left text-xs font-semibold uppercase tracking-wide">
                  Bank remarks
                </th>
            ...
            <tbody>
              {data.map((row, index) => {
                ...
                return (
                  <tr
                    key={rowKey}
                    className={`border-b border-slate-100 align-top transition-colors hover:bg-blue-50/50 ${
                  ...
                  >
                    ...
                    <td className="px-4 py-3">
                      <span className="inline-flex max-w-[180px] truncate rounded-full bg-blue-50 px-2.5 py-1 text-xs font-semibold text-blue-700 ring-1 ring-blue-100">
                        {receivedByName}
                      </span>
                    </td>
                    ...
                    <td className="px-4 py-3 text-right">
                      {isEditing && ispermissionEdit ? (
                        <input
                          ...
                          className="w-32 rounded-lg border border-blue-300 px-2 py-1.5 text-right text-sm outline-none transition focus:border-blue-500 focus:ring-2 focus:ring-blue-200 [appearance:textfield] [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:appearance-none"
                    ...
                    <td className="px-4 py-3">
                      {isEditing && ispermissionEdit ? (
                        <input
                          ...
                          value={editedData?.bankRemarks ?? ""}
                          onChange={(event) =>
                            handleInputChange("bankRemarks", event.target.value)
                          }
                          className="w-full min-w-[200px] rounded-lg border border-blue-300 px-2 py-1.5 text-sm outline-none transition focus:border-blue-500 focus:ring-2 focus:ring-blue-200"
                          placeholder="Enter bank remarks"
                          aria-label="Bank remarks"
                        />
                      ) : (
                        <p className="max-w-sm whitespace-normal break-words text-slate-600">
                        ...
                        <div className="flex min-w-[120px] flex-col items-center justify-center gap-2">
                          ...
                          {message?.warning &&
                            messageRowIndex === row?.originalIndex && (
                              <p
                                role="alert"
                                className="max-w-[220px] rounded-md border border-red-200 bg-red-50 px-2 py-1 text-left text-xs leading-4 text-red-700"
                              >
                                {message.warning}
                              </p>
                            )}
...
<table className="w-full min-w-[760px] table-fixed border-collapse text-sm">
  <colgroup>
    <col className={!verifiedLead && showAction ? "w-[22%]" : "w-[25%]"} />
    <col className={!verifiedLead && showAction ? "w-[20%]" : "w-[23%]"} />
    <col className={!verifiedLead && showAction ? "w-[14%]" : "w-[17%]"} />
    <col className={!verifiedLead && showAction ? "w-[29%]" : "w-[35%]"} />

    {!verifiedLead && showAction && <col className="w-[15%]" />}
  </colgroup>
        ...
        >
          ...
          <td className="px-4 py-3 text-center">
            {isEditing && ispermissionEdit ? (
              ...
              <p
                title={row?.bankRemarks?.trim() || "No bank remarks"}
                  ...
                  <>
                    ...
                    {isdepartmentisAccountant && (
                      <button
                        type="button"
                        onClick={() =>
                          handleVerify(rowOriginalIndex, checkverified)
                        }
                        disabled={submitLoading}
                        className={`inline-flex h-8 items-center gap-1.5 rounded-lg px-2.5 text-xs font-semibold text-white shadow-sm transition disabled:cursor-not-allowed disabled:opacity-60 ${
