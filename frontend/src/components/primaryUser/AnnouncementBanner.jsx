...
//       {/* Single static content block — no ticker/marquee */}
...
// function AnnouncementContent({ item, style }) {
//   return (
//     <div className="flex h-full items-center gap-2.5 truncate">
//       <span className="flex-none truncate text-[13px] font-semibold text-slate-800">
//         {item.title}
//       </span>
...
//           <span className="min-w-0 truncate text-[13px] text-slate-500">{item.detail}</span>
//         </>
//       )}
...
//       {item.postedBy && (
//         <span className="hidden flex-none items-center gap-1 text-[11px] font-medium text-slate-400 md:inline-flex">
//           <User className="h-3 w-3" strokeWidth={2.25} />
//           {item.postedBy}
//         </span>
//       )}
