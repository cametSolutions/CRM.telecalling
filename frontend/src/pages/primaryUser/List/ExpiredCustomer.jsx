...
const ExpiredCustomer = () => {
  ...
  //   if (expiredCustomerCalls) {
  //     console.log("vvvvvvvvvvvvvvv")
  //     const callls = expiredCustomerCalls
  //       .filter(
  //         (customer) =>
  //           selectedBranch === "All" ||
  ...
  //       })
  //     if (callls) {
  //       console.log("callsexpiredddddddddddddddd", callls)
  //     }
  //   }
  // }, [expiredCustomerCalls])
  console.log("qqqqqqqq", expiredCustomerCalls)
  useEffect(() => {
    if (isCallsToggled && expiredCustomerId) {
      const fetchExpiryRegisterList = async () => {
        try {
          ...
          console.log("expiredcalls in useefet", calls)
          setExpiredCustomerCalls(calls)
          // setexpiryRegisterList(data) // Update state with new data
          // setLoading(false)
        } catch (error) {
          console.error("Error fetching user list:", error)
