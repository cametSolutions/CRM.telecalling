...
TargetConfigurationSchema.index({ branch: 1, startDate: 1, endDate: 1 })
TargetConfigurationSchema.index({ branch: 1, periodName: 1 })
TargetConfigurationSchema.index({ branch: 1, year: 1 })
TargetConfigurationSchema.index({ branch: 1, categoryId: 1, status: 1 })
TargetConfigurationSchema.index({ categoryId: 1, status: 1 })
TargetConfigurationSchema.index({ "monthlyTargets.year": 1, "monthlyTargets.month": 1 })
TargetConfigurationSchema.index({
    branch: 1,
    "monthlyTargets.year": 1,
    "monthlyTargets.month": 1,
})
TargetConfigurationSchema.index({ "monthlyTargets.userTargets.userId": 1 })
TargetConfigurationSchema.index({
    branch: 1,
    "monthlyTargets.userTargets.userId": 1,
    "monthlyTargets.year": 1,
    "monthlyTargets.month": 1,
})
